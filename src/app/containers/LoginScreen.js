...
import {defineStoreItem, deleteStoreWatcher, useStoreState} from '../utils/store/commonStore';
  ...
  *-------------------------------------------------------------------------------*/
  ...
  useEffect(() => {
    ...
    if (!_.isEmpty(userInfo)) {
      let initialTabName = "ToDoListScreen"; // 임시로 하드코딩 처리
      timer = setTimeout(() => {
